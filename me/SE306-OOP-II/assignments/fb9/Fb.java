...
public class Fb {
	...
	private void loadDataInTable() {
		...
		model =	fileManager.loadInTable();// these can't be printed
		table = new JTable(model);
	...
	private void makeAccountCreatorButton(JTextField tFieldOfFirstname, JTextField tFieldOfSurname, JTextField tFieldOfMobile) {
		...
		jbCreatAc.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				...
				else if(fileManager.isEmailExist(mobOrEmail)< fileManager.getAccountNo())JOptionPane.showMessageDialog(null, "Account already exist,"
	...
	private void makeLogInPart(JPanel panelOfTitleBar) {
		...
		jbLongIn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				foundIndex =fileManager.isEmailExist(tfEmail.getText());
				if(foundIndex >= fileManager.getAccountNo()) JOptionPane.showMessageDialog(null, "Account doesn't exist","Error",JOptionPane.ERROR_MESSAGE);
				
				else if(!fileManager.isPasswordCorrect(logInPasswordField.getPassword(),foundIndex))
