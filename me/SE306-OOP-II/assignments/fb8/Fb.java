...
public class Fb {
	...
	private void loadDataInTable() {
		...
		model = fileManager.loadInTable(model);	
		...
		jbCreatAc.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				...
				if(!checkPatter(firstName,surName,mobOrEmail)) ;
					...
					model.addRow(new Object[]{serialNo,firstName,surName,gender,day+"-"+month+"-"+year,gender});
	...
	private void makeLogInPart(JPanel panelOfTitleBar) {
		...
		jbLongIn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(!fileManager.isEmailExist(tfEmail.getText())) JOptionPane.showMessageDialog(null, "Account doesn't exist","Error",JOptionPane.ERROR_MESSAGE);
				else if(!fileManager.isPasswordCorrect(logInPasswordField.getPassword(),mobOrEmail))
	...
	private void showAllInformation() {
		...
		frameOfAllinformations.setSize(1370, 738);
		
		JLabel name1 = new JLabel("FirstName:"+ accounts.get(mobOrEmail).getFirstName());
		name1.setFont(new Font("sherif", Font.BOLD, 30));
		frameOfAllinformations.add(name1);
		
		JLabel surname1 = new JLabel("Surname:"+accounts.get(mobOrEmail).getSurName());
		surname1.setFont(new Font("sherif", Font.BOLD, 30));
		frameOfAllinformations.add(surname1);
		
		JLabel mobileNo = new JLabel();
		if(mobOrEmail.startsWith("01")) mobileNo.setText("Mobile:"+ accounts.get(mobOrEmail).getMobOrEmail());
		...
		frameOfAllinformations.add(birthday);
		
		JLabel gender1 = new JLabel("Gender:"+accounts.get(mobOrEmail).getGender());
